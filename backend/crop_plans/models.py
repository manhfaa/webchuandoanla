...
class CropPlan(models.Model):
    ...
    ai_reasoning_summary_en = models.TextField(blank=True, default="")
...
class CropPlanStep(models.Model):
    ...
    short_label_en = models.CharField(max_length=140, blank=True, default="")
    description = models.TextField()
    description_en = models.TextField(blank=True, default="")
    why_this_step_matters = models.TextField(blank=True, default="")
    why_this_step_matters_en = models.TextField(blank=True, default="")
    prerequisites = models.JSONField(default=list, blank=True)
    prerequisites_en = models.JSONField(default=list, blank=True)
    tools_needed = models.JSONField(default=list, blank=True)
    tools_needed_en = models.JSONField(default=list, blank=True)
    ...
    completion_condition_en = models.TextField(blank=True, default="")
    risk_notes = models.JSONField(default=list, blank=True)
    risk_notes_en = models.JSONField(default=list, blank=True)
    ...
    water_amount_unit_en = models.CharField(max_length=60, blank=True, default="")
    ...
    fertilizer_amount_unit_en = models.CharField(max_length=60, blank=True, default="")
    sunlight_requirement_text = models.CharField(max_length=150, blank=True, default="")
    sunlight_requirement_text_en = models.CharField(max_length=220, blank=True, default="")
