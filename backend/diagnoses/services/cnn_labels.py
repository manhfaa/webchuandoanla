...
DISEASE_TRANSLATIONS = {
    ...
    "Bacterial Canker": "Loét vi khuẩn",
    "Bacterial Wilt": "Héo vi khuẩn",
    "Banded Chlorosis": "Vàng lá sọc dải",
    "Bell pepper leaf spot": "Đốm lá ớt chuông",
    "Black rot": "Thối đen",
    "Brown Rust": "Gỉ nâu",
    "Brown Spot": "Đốm nâu",
    "Cedar-Apple Rust": "Gỉ sắt tuyết tùng trên táo",
    "Cedar apple rust": "Gỉ sắt tuyết tùng trên táo",
    "Cercospora": "Bệnh đốm lá Cercospora",
    "Cutting Weevil": "Mọt cắt cành",
    "Die Back": "Khô cành",
    "Downy Mildew": "Bệnh sương mai",
    "Dried Leaves": "Khô lá",
    "Gall Midge": "Muỗi đục chồi",
    "Grassy shoot": "Bệnh chồi cỏ",
    "Gummy Stem Blight": "Bệnh nứt thân chảy nhựa",
    "Leaf blight": "Cháy lá",
    "Maize Lethal Necrosis": "Hoại tử chết cây ngô",
    "Maize Streak Virus": "Virus sọc lá ngô",
    "Miner": "Sâu đục lá",
    "Mites": "Nhện hại lá",
    "Mosaic virus": "Virus khảm",
    "Phoma": "Bệnh đốm lá Phoma",
    "Pokkah Boeng": "Bệnh Pokkah Boeng",
    "Powdery mildew": "Bệnh phấn trắng",
    "Red leaf spot": "Đốm đỏ trên lá",
    "Red scab": "Ghẻ đỏ",
    "Rust": "Gỉ sắt",
    "Scab": "Bệnh ghẻ",
    "Sett Rot": "Thối hom",
    ...
    "Two-spotted spider mites": "Nhện đỏ hai chấm",
    "Verticillium wilt": "Héo Verticillium",
    "Yellow Leaf": "Vàng lá",
    "Yellow Leaf Curl Virus": "Virus xoăn vàng lá",
    "bacterial blight": "Bạc lá vi khuẩn",
    "brown spot": "Đốm nâu",
    "green mite": "Nhện xanh",
    "leaf miner": "Sâu đục lá",
    "mosaic virus": "Virus khảm",
    "red rust": "Gỉ đỏ",
    "yellow mottle virus": "Virus đốm vàng",
