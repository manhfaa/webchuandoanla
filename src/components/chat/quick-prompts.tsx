...
export function QuickPrompts({ prompts, onSelect }: { prompts: QuickPrompt[]; onSelect: (prompt: QuickPrompt) => void }) {
  return (
    <Card variant="default" padding="lg" className="rounded-xl">
      <div className="flex items-center gap-2"><Sparkles size={17} className="text-leaf-strong" aria-hidden /><h3 className="text-base font-bold text-ink">Câu hỏi gợi ý</h3></div>
